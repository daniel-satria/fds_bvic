...
def update_historical(
    ...
    """
    Load daily IBMB files and filter for pembayaran non QR records only.
    ...
    if not dataframes:
        ...
        logger.warning("Updating historical non-QR process finished.")
        return
    ...
    try:
        ...
        logger.error("Updating historical non-QR process terminated.")
        return
