...
def filter_date(
    df: pl.DataFrame,
    n_days: int = CONSTS.params_tf_online_50mio.n_days,
...
def flag_tf_online_50mio(
    ...
    temp_date_col: str = CONSTS.flag.temp_date_col,
    rolling_window: int = CONSTS.params_tf_online_50mio.rolling_window,
    threshold: int = CONSTS.params_tf_online_50mio.threshold,
) -> None:
    """
